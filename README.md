...
- [Ejercicio N°02](https://github.com/csaybar/EarthEngineMasterGIS/blob/master/tarea/indices.ipynb): Elaborar un Mapa de Índice espectral puede ser NDVI, NDSI, NDWI, etc.) 
### :gift: **Snippets**
